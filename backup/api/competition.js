...
export function endCompetition(id) {
  return apiClient.post(`/competitions/${id}/end`);
}
...
export function registerForCompetition(id) {
  return apiClient.post(`/competitions/${id}/register`);
}
...
export function cancelCompetitionRegistration(id) {
  return apiClient.delete(`/competitions/${id}/register`);
}
...
export function getCompetitionParticipants(id) {
  return apiClient.get(`/competitions/${id}/participants`);
}
